class ZCL_SHOP_API_READ_F10 definition
  public
  create public .
...
CLASS ZCL_SHOP_API_READ_F10 IMPLEMENTATION.
...
DATA:
  ls_entity_key    TYPE ZONLINE_SHOP68CF997733,
  ls_business_data TYPE ZONLINE_SHOP68CF997733,
...
DATA(lo_destination) = cl_http_destination_provider=>create_by_comm_arrangement(
                                             comm_scenario  = 'Z_SHOP_SCENARIO_OUTBOUND_F10'
                                             service_id     = 'Z_SHOP_API_READ_OBS_F10_REST' ).
     ...
     lo_client_proxy = /iwbep/cl_cp_factory_remote=>create_v2_remote_proxy(
       EXPORTING
          is_proxy_model_key       = VALUE #( repository_id       = 'SRVD'
                                              proxy_model_id      = 'Z_SHOP_API_SCM_F10'
...
" Set entity key
ls_entity_key = VALUE #(
          order_uuid  = 'DF0B7D5455421EDE8AAD8D48FC028A0C' ).
