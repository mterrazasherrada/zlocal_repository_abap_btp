CLASS zcl_shop_api_read_c40 DEFINITION
  PUBLIC
  CREATE PUBLIC .
...
CLASS ZCL_SHOP_API_READ_C40 IMPLEMENTATION.


  METHOD if_http_service_extension~handle_request.

    DATA:
      ls_entity_key    TYPE zonline_shop0bb93417b6,
      ls_business_data TYPE zonline_shop0bb93417b6,
    ...
    TRY.
        ...
        DATA(lo_destination) = cl_http_destination_provider=>create_by_comm_arrangement(
                                                     comm_scenario  = 'Z_SHOP_SCENARIO_OUTBOUND_C40'

                                                     service_id     = 'Z_SHOP_API_READ_OBS_C40_REST' ).
*lo_http_client = cl_web_http_client_manager=>create_by_http_destination( lo_destination ).
        ...
        lo_client_proxy = /iwbep/cl_cp_factory_remote=>create_v2_remote_proxy(
          EXPORTING
             is_proxy_model_key       = VALUE #( repository_id       = 'SRVD'
                                                 proxy_model_id      = 'Z_SHOP_API_SCM_C40'
        ...
        " Set entity key
        ls_entity_key = VALUE #(
                  order_uuid  = 'E7AA1C3D298B1EDE818D04184F3A4B70' ).
