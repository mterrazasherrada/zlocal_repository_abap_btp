class ZCL_SHOP_API_READ_C32 definition
  public
  create public .
...
CLASS ZCL_SHOP_API_READ_C32 IMPLEMENTATION.


  method IF_HTTP_SERVICE_EXTENSION~HANDLE_REQUEST.

DATA:
  ls_entity_key    TYPE ZONLINE_SHOPD6DD8476A3,
  ls_business_data TYPE ZONLINE_SHOPD6DD8476A3,
...
DATA(lo_destination) = cl_http_destination_provider=>create_by_comm_arrangement(
                                             comm_scenario  = 'Z_SHOP_SCENARIO_OUTBOUND_C32'
  "*                                           comm_system_id = ''
                                             service_id     = 'Z_SHOP_API_READ_OBS_C32_REST' ).
     ...
     lo_client_proxy = /iwbep/cl_cp_factory_remote=>create_v2_remote_proxy(
       EXPORTING
          is_proxy_model_key       = VALUE #( repository_id       = 'SRVD'
                                              proxy_model_id      = 'Z_SHOP_API_SCM_C32'
