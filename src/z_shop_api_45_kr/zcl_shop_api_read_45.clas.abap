CLASS zcl_shop_api_read_45 DEFINITION
  PUBLIC
  CREATE PUBLIC .
...
CLASS ZCL_SHOP_API_READ_45 IMPLEMENTATION.
  ...
  METHOD if_http_service_extension~handle_request.
    ...
    DATA:
      ls_entity_key    TYPE zonline_shop0283f1d516,
      ls_business_data TYPE zonline_shop0283f1d516,
    ...
    TRY.
        ...
        DATA(lo_destination) = cl_http_destination_provider=>create_by_comm_arrangement(
                                                     comm_scenario  = 'Z_SHOP_SCENARIO_OUTBOUND_45'
                                                     service_id     = 'Z_SHOP_API_READ_OBS_45_REST' ).
        lo_http_client = cl_web_http_client_manager=>create_by_http_destination( lo_destination ).

        lo_client_proxy = cl_web_odata_client_factory=>create_v2_remote_proxy(
          EXPORTING
            iv_service_definition_name = 'Z_SHOP_API_SCM_45'
...
*                                        proxy_model_id      = 'Z_SHOP_API_SCM_45'
...
*    iv_relative_service_root   = '<service_root>' ).
        ...
        " Set entity key
        ls_entity_key = VALUE #(
                  order_uuid  = 'AD19D34E17221EDDAFC544847E21CC36' ).
