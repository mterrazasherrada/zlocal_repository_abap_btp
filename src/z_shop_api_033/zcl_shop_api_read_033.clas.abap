class ZCL_SHOP_API_READ_033 definition
  public
  create public .
...
CLASS ZCL_SHOP_API_READ_033 IMPLEMENTATION.
  ...
  method IF_HTTP_SERVICE_EXTENSION~HANDLE_REQUEST.
    ...
    lo_http_client = cl_web_http_client_manager=>create_by_http_destination( lo_destination ).
         ...
         lo_client_proxy = cl_web_odata_client_factory=>create_v2_remote_proxy(
           EXPORTING
             iv_service_definition_name = 'Z_SHOP_API_SCM_033'
...
*                                            proxy_model_id      = 'Z_SHOP_API_SCM_033'
...
*        iv_relative_service_root   = '<service_root>' ).
    ...
    " Set entity key
    ls_entity_key = VALUE #(
              order_uuid  = 'AD19D34E17221EDDA9DE7EFC9F0E96BF' ).
