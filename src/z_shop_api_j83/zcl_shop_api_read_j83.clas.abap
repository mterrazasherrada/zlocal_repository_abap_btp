CLASS zcl_shop_api_read_j83 DEFINITION
  PUBLIC
  CREATE PUBLIC .
...
CLASS ZCL_SHOP_API_READ_J83 IMPLEMENTATION.


  METHOD if_http_service_extension~handle_request.

    DATA:
      ls_entity_key    TYPE zonline_shopa7aba877be,
      ls_business_data TYPE zonline_shopa7aba877be,
    ...
    TRY.
        ...
        DATA(lo_destination) = cl_http_destination_provider=>create_by_comm_arrangement(
                                                     comm_scenario  = 'Z_SHOP_SCENARIO_OUTBOUND_J83'
*                                             comm_system_id = '<Comm System Id>'
                                                     service_id     = 'Z_SHOP_API_READ_OBS_J83_REST' ).
        ...
        EXPORTING
        iv_service_definition_name = 'Z_SHOP_API_SCM_J83'
        ...
        " Set entity key
        ls_entity_key = VALUE #(
                  order_uuid  = 'DF0B7D5455421EDE87FDC6EC47EB5644' ).
