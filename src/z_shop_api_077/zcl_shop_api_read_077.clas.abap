class ZCL_SHOP_API_READ_077 definition
  public
  create public .
...
CLASS ZCL_SHOP_API_READ_077 IMPLEMENTATION.
  ...
  method IF_HTTP_SERVICE_EXTENSION~HANDLE_REQUEST.
    ...
    DATA:
      ls_entity_key    TYPE ZONLINE_SHOP8088FF7902,
      ls_business_data TYPE ZONLINE_SHOP8088FF7902,
    ...
    DATA(lo_destination) = cl_http_destination_provider=>create_by_comm_arrangement(
                                                 comm_scenario  = 'Z_SHOP_SCENARIO_OUTBOUND_077'
*                                                 comm_system_id = '<Comm System Id>'
                                                 service_id     = 'Z_SHOP_API_READ_OBS_077_REST' ).
    lo_http_client = cl_web_http_client_manager=>create_by_http_destination( lo_destination ).

         lo_client_proxy = cl_web_odata_client_factory=>create_v2_remote_proxy(
           EXPORTING
             iv_service_definition_name = 'Z_SHOP_API_SCM_077'
...
*                                            proxy_model_id      = 'Z_SHOP_API_SCM_077'
...
*        iv_relative_service_root   = '<service_root>' ).
    ...
    " Set entity key
    ls_entity_key = VALUE #(
              order_uuid  = 'AD19D34E17221EDDAFC9F6B9F6FBDADE' ).
