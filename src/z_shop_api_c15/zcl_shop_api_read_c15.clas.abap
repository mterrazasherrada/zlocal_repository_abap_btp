class ZCL_SHOP_API_READ_C15 definition
  public
  create public .
...
CLASS ZCL_SHOP_API_READ_C15 IMPLEMENTATION.
...
DATA:
  ls_entity_key    TYPE ZONLINE_SHOPEACB487429,
  ls_business_data TYPE ZONLINE_SHOPEACB487429,
...
" Create http client
 DATA(lo_destination) = cl_http_destination_provider=>create_by_comm_arrangement(
                                             comm_scenario  = 'Z_SHOP_SCENARIO_OUTBOUND_C15'
                                             service_id     = 'Z_SHOP_API_READ_OBS_C15_REST' ).
     ...
     lo_client_proxy = /iwbep/cl_cp_factory_remote=>create_v2_remote_proxy(
       EXPORTING
          is_proxy_model_key       = VALUE #( repository_id       = 'SRVD'
                                              proxy_model_id      = 'Z_SHOP_API_SCM_C15'
...
" Set entity key
ls_entity_key = VALUE #(
          order_uuid  = 'E7AA1C3D298B1EDDBFEEF58C68C22D6A' ).
