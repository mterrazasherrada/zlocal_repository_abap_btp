CLASS zcl_shop_api_read_j02 DEFINITION
  PUBLIC
  CREATE PUBLIC .
...
CLASS ZCL_SHOP_API_READ_J02 IMPLEMENTATION.
  ...
  METHOD if_http_service_extension~handle_request.
    ...
    DATA:
      ls_entity_key    TYPE zonline_shopaf2c9fd9ba,
      ls_business_data TYPE zonline_shopaf2c9fd9ba,
    ...
    TRY.
        ...
        DATA(lo_destination) = cl_http_destination_provider=>create_by_comm_arrangement(
                                                     comm_scenario  = 'Z_SHOP_SCENARIO_OUTBOUND_J02'
...
*                                                 proxy_model_id      = 'Z_SHOP_API_SCM_J02'
...
*            iv_relative_service_root   = '<service_root>' ).
        ...
        EXPORTING
        iv_service_definition_name = 'Z_SHOP_API_SCM_J02'
        io_http_client = lo_http_client
        ...
        " Set entity key
        ls_entity_key = VALUE #(
                  order_uuid  = 'E7AA1C3D298B1EEE86DB382E39E95AA9' ).
