class ZCL_SHOP_API_READ_J19 definition
  public
  create public .
...
CLASS ZCL_SHOP_API_READ_J19 IMPLEMENTATION.


  method IF_HTTP_SERVICE_EXTENSION~HANDLE_REQUEST.

DATA:
  ls_entity_key    TYPE ZONLINE_SHOP77E21AE6FF,
  ls_business_data TYPE ZONLINE_SHOP77E21AE6FF,
...
DATA(lo_destination) = cl_http_destination_provider=>create_by_comm_arrangement(
                                             comm_scenario  = 'Z_SHOP_SCENARIO_OUTBOUND_J19'
*                                             comm_system_id = '<Comm System Id>'
                                             service_id     = 'Z_SHOP_API_READ_OBS_J19_REST' ).
lo_http_client = cl_web_http_client_manager=>create_by_http_destination( lo_destination ).
 ...
 EXPORTING
 iv_service_definition_name = 'Z_SHOP_API_SCM_J19'
...
*                                              proxy_model_id      = 'Z_SHOP_API_SCM_J19'
...
" Set entity key
ls_entity_key = VALUE #(
          order_uuid  = 'E7AA1C3D298B1EDE86DBD02D25FDD2DB' ).
