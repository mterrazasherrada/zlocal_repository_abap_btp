class ZCL_SHOP_API_READ_B13 definition
  public
  create public .
...
CLASS ZCL_SHOP_API_READ_B13 IMPLEMENTATION.
   ...
   DATA:
    ...
    TRY.
        DATA(lo_destination) = cl_http_destination_provider=>create_by_comm_arrangement(
                                                     comm_scenario  = 'Z_SHOP_SCENARIO_OUTBOUND_B13'
                                                     service_id     = 'Z_SHOP_API_READ_OBS_B13_REST' ).
        lo_http_client = cl_web_http_client_manager=>create_by_http_destination( lo_destination ).

        lo_client_proxy = cl_web_odata_client_factory=>create_v2_remote_proxy(
          EXPORTING
            iv_service_definition_name = 'Z_SHOP_API_SCM_B13'
        ...
        " Set entity key
        ls_entity_key = VALUE #(
                  order_uuid  = 'DD5F294E1FD01EEDB79DA0AF51445A2B' ).
