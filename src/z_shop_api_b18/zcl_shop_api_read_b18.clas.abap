class ZCL_SHOP_API_READ_B18 definition
  public
  create public .
...
CLASS ZCL_SHOP_API_READ_B18 IMPLEMENTATION.


  method IF_HTTP_SERVICE_EXTENSION~HANDLE_REQUEST.

DATA:
  ls_entity_key    TYPE ZONLINE_SHOP7730489309,
  ls_business_data TYPE ZONLINE_SHOP7730489309,
...
DATA(lo_destination) = cl_http_destination_provider=>create_by_comm_arrangement(
                                             comm_scenario  = 'Z_SHOP_SCENARIO_OUTBOUND_B18'
                                             service_id     = 'Z_SHOP_API_READ_OBS_B18_REST' ).
lo_http_client = cl_web_http_client_manager=>create_by_http_destination( lo_destination ).

     lo_client_proxy = cl_web_odata_client_factory=>create_v2_remote_proxy(
       EXPORTING
         iv_service_definition_name = 'Z_SHOP_API_SCM_B18'
...
*                                        proxy_model_id      = 'Z_SHOP_API_SCM_B18'
...
" Set entity key
ls_entity_key = VALUE #(
          order_uuid  = 'CFF7131367531EEDB6A6CEBCCBFDF3E7' ).
