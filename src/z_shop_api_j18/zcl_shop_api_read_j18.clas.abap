CLASS zcl_shop_api_read_j18 DEFINITION
PUBLIC
CREATE PUBLIC .
PUBLIC SECTION.
...
CLASS ZCL_SHOP_API_READ_J18 IMPLEMENTATION.
...
comm_scenario = 'Z_SHOP_SCENARIO_OUTBOUND_J18'
* comm_system_id = '<Comm System Id>'
service_id = 'Z_SHOP_API_READ_OBS_J18_REST' ).
lo_http_client = cl_web_http_client_manager=>create_by_http_destination( lo_destination ).
lo_client_proxy = cl_web_odata_client_factory=>create_v2_remote_proxy(
EXPORTING
iv_service_definition_name = 'Z_SHOP_API_SCM_J18'
...
* proxy_model_id = 'Z_SHOP_API_SCM_J18'
* proxy_model_version = '0001' )
* io_http_client = lo_http_client
* iv_relative_service_root = '<service_root>' ).
" Set entity key
ls_entity_key = VALUE #(
order_uuid = 'E7AA1C3D298B1EDE86DC491C1BCB5FFA' ).
