class ZCL_SHOP_API_READ_103 definition
  public
  create public .
...
CLASS ZCL_SHOP_API_READ_103 IMPLEMENTATION.
...
DATA:
  ls_entity_key    TYPE ZONLINE_SHOP16C8829E4F,
  ...
  lo_response      TYPE REF TO /iwbep/if_cp_response_read.
     ...
     " Create http client
        DATA(lo_destination) = cl_http_destination_provider=>create_by_comm_arrangement(
                                                    ...
                                                    service_id     = 'Z_SHOP_API_READ_OBS_103_REST' ).
...
*         iv_relative_service_root   = '' ).
        lo_client_proxy = cl_web_odata_client_factory=>create_v2_remote_proxy(
            EXPORTING
                iv_service_definition_name = 'Z_SHOP_API_SCM_103'
                io_http_client            = lo_http_client
                iv_relative_service_root   = '').
