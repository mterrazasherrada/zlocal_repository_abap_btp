class ZCL_SHOP_API_READ_C09 definition
  public
  create public .
...
CLASS ZCL_SHOP_API_READ_C09 IMPLEMENTATION.


  method IF_HTTP_SERVICE_EXTENSION~HANDLE_REQUEST.
DATA:
  ls_entity_key    TYPE ZONLINE_SHOPBA1DFC0002,
  ls_business_data TYPE ZONLINE_SHOPBA1DFC0002,
...
DATA(lo_destination) = cl_http_destination_provider=>create_by_comm_arrangement(
                                             comm_scenario  = 'Z_SHOP_SCENARIO_OUTBOUND_C09'
                                             service_id     = 'Z_SHOP_API_READ_OBS_C09_REST' ).
...
*                                              proxy_model_id      = 'Z_SHOP_API_SCM_C09'
...
*         iv_relative_service_root   = '<service_root>' ).
         ...
         lo_client_proxy = cl_web_odata_client_factory=>create_v2_remote_proxy(
           EXPORTING
             iv_service_definition_name = 'Z_SHOP_API_SCM_C09'
             io_http_client             = lo_http_client
             iv_relative_service_root   = '' ).

" Set entity key
ls_entity_key = VALUE #(
          order_uuid  = 'E7AA1C3D298B1EDE81EE661CEE6D3620' ).
