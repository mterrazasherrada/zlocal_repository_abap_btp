class ZCL_SHOP_API_READ_J11 definition
  public
  create public .
...
CLASS ZCL_SHOP_API_READ_J11 IMPLEMENTATION.


  method IF_HTTP_SERVICE_EXTENSION~HANDLE_REQUEST.

DATA:
  ls_entity_key    TYPE ZONLINE_SHOPF82105FB94,
  ls_business_data TYPE ZONLINE_SHOPF82105FB94,
...
DATA(lo_destination) = cl_http_destination_provider=>create_by_comm_arrangement(
                                             comm_scenario  = 'Z_SHOP_SCENARIO_OUTBOUND_J11'
*                                             comm_system_id = '<Comm System Id>'
                                             service_id     = 'Z_SHOP_API_READ_OBS_J11_REST' ).
...
EXPORTING
iv_service_definition_name = 'Z_SHOP_API_SCM_J11'
io_http_client = lo_http_client
iv_relative_service_root = '' ).
*     lo_client_proxy = /iwbep/cl_cp_factory_remote=>create_v2_remote_proxy(
*       EXPORTING
*          is_proxy_model_key       = VALUE #( repository_id       = 'SRVD'
*                                              proxy_model_id      = 'Z_SHOP_API_SCM_J11'
...
" Set entity key
ls_entity_key = VALUE #(
          order_uuid  = 'E7AA1C3D298B1EEE86DB228D1F2853AA' ).
