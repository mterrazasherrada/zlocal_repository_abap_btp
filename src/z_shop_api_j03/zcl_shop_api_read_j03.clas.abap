class ZCL_SHOP_API_READ_J03 definition
  public
  create public .
...
CLASS ZCL_SHOP_API_READ_J03 IMPLEMENTATION.
...
DATA:
  ls_entity_key    TYPE ZONLINE_SHOP8C17239C65,
  ls_business_data TYPE ZONLINE_SHOP8C17239C65,
...
DATA(lo_destination) = cl_http_destination_provider=>create_by_comm_arrangement(
                                             comm_scenario  = 'Z_SHOP_SCENARIO_OUTBOUND_J03'
*                                             comm_system_id = '<Comm System Id>'
                                             service_id     = 'Z_SHOP_API_READ_OBS_J03_REST' ).
...
*                                              proxy_model_id      = 'Z_SHOP_API_SCM_J03'
*                                              proxy_model_version = '0001' )
*         io_http_client             = lo_http_client
*         iv_relative_service_root   = '<service_root>' ).
    lo_client_proxy = cl_web_odata_client_factory=>create_v2_remote_proxy(
        exporting
          iv_service_definition_name = 'Z_SHOP_API_SCM_J03'
          io_http_client             = lo_http_client
...
" Set entity key
ls_entity_key = VALUE #(
          order_uuid  = 'E7AA1C3D298B1EEE86DD31A874E20DF2' ).
