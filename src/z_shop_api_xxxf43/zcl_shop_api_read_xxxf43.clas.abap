class ZCL_SHOP_API_READ_XXXF43 definition
PUBLIC
CREATE PUBLIC .
PUBLIC SECTION.
...
CLASS ZCL_SHOP_API_READ_XXXF43 IMPLEMENTATION.
...
comm_scenario = 'Z_SHOP_SCENARIO_OUTBOUND_XXF43'
* comm_system_id = '<Comm System Id>'
service_id = 'Z_SHOP_API_READ_OBS_XXXXF43_REST' ).
lo_http_client = cl_web_http_client_manager=>create_by_http_destination( lo_destination ).
lo_client_proxy = cl_web_odata_client_factory=>create_v2_remote_proxy(
EXPORTING
iv_service_definition_name = 'Z_SHOP_API_SCM_XXF43'
