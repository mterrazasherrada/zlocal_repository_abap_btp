CLASS zcl_shop_api_read_031 DEFINITION
  PUBLIC
  CREATE PUBLIC .
...
CLASS ZCL_SHOP_API_READ_031 IMPLEMENTATION.
  ...
  METHOD if_http_service_extension~handle_request.
    ...
    DATA:
      ls_entity_key    TYPE zonline_shop529f063572, "<structure_name>,
      ls_business_data TYPE zonline_shop529f063572, "<structure_name>,
    ...
    TRY.
        ...
        DATA(lo_destination) = cl_http_destination_provider=>create_by_comm_arrangement(
                                                     comm_scenario  = 'Z_SHOP_SCENARIO_OUTBOUND_031'
                                                     "comm_system_id = 'Z_SHOP_API_READ_OBS_031_REST'
                                                     service_id     = 'Z_SHOP_API_READ_OBS_031_REST' ).
        ...
        lo_client_proxy = cl_web_odata_client_factory=>create_v2_remote_proxy(
            EXPORTING
                iv_service_definition_name = 'Z_SHOP_API_SCM_031'
...
*                                                 proxy_model_id      = 'Z_SHOP_API_SCM_031'
...
*            iv_relative_service_root   = '<service_root>' ).
        ...
        ls_entity_key = VALUE #(
                  ...
                  order_uuid  = 'E7AA1C3D298B1EEE81F0107E50D7CDB3' ).
