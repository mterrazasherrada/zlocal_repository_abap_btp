...
CLASS zcl_shop_api_read_xf43 DEFINITION
 PUBLIC
 CREATE PUBLIC .
 PUBLIC SECTION.
...
CLASS ZCL_SHOP_API_READ_XF43 IMPLEMENTATION.
 ...
 comm_scenario = 'Z_SHOP_SCENARIO_OUTBOUND_XF43'
 "comm_system_id = 'Z_SHOP_API_COMSYS_F43'
 service_id = 'Z_SHOP_API_READ_OBS_XXF43_REST' ).
 lo_http_client = cl_web_http_client_manager=>create_by_http_destination( lo_destination ).
 lo_client_proxy = cl_web_odata_client_factory=>create_v2_remote_proxy(
 EXPORTING
 iv_service_definition_name = 'Z_SHOP_API_SCM_XF43'
 io_http_client = lo_http_client
 iv_relative_service_root = '' ).
 " Set entity key
 ls_entity_key = VALUE #(
 order_uuid = 'DF0B7D5455421EDE89CE38B92C26DF6B' ).
