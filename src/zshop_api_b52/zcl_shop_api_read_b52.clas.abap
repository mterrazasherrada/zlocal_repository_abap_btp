class ZCL_SHOP_API_READ_B52 definition
  public
  create public .
...
CLASS ZCL_SHOP_API_READ_B52 IMPLEMENTATION.
...
*                                             comm_system_id = '<Comm System Id>'
                                                     service_id     = 'Z_SHOP_API_READ_OBS_B52_REST' ).
        lo_http_client = cl_web_http_client_manager=>create_by_http_destination( lo_destination ).

        lo_client_proxy = cl_web_odata_client_factory=>create_v2_remote_proxy(
          EXPORTING
            iv_service_definition_name = 'Z_SHOP_API_SCM_B52'
