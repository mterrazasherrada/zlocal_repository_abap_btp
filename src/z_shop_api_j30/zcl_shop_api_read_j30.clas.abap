CLASS zcl_shop_api_read_j30 DEFINITION
  PUBLIC
  CREATE PUBLIC .
...
CLASS ZCL_SHOP_API_READ_J30 IMPLEMENTATION.
  ...
  METHOD if_http_service_extension~handle_request.
    ...
    DATA:
      ls_entity_key    TYPE zonline_shopc7f9332b68,
      ls_business_data TYPE zonline_shopc7f9332b68,
    ...
    TRY.
        ...
        DATA(lo_destination) = cl_http_destination_provider=>create_by_comm_arrangement(
                                                     comm_scenario  = 'Z_SHOP_SCENARIO_OUTBOUND_J30'
*                                             comm_system_id = '<Comm System Id>'
                                                     service_id     = 'Z_SHOP_API_READ_OBS_J30_REST' ).
        ...
        EXPORTING
        iv_service_definition_name = 'Z_SHOP_API_SCM_J30'
...
*                                                 proxy_model_id      = 'Z_SHOP_API_SCM_J30'
...
*            iv_relative_service_root   = '<service_root>' ).
        ...
        " Set entity key
        ls_entity_key = VALUE #(
                  order_uuid  = 'E7AA1C3D298B1EEE86DAF0050BC689BE' ).
