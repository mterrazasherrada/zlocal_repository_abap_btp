class ZCL_SHOP_API_READ_E05 definition
  public
  create public .
...
CLASS ZCL_SHOP_API_READ_E05 IMPLEMENTATION.
...
DATA:
  ls_entity_key    TYPE ZONLINE_SHOP22C94F3805,
  ls_business_data TYPE ZONLINE_SHOP22C94F3805,
...
DATA(lo_destination) = cl_http_destination_provider=>create_by_comm_arrangement(
                                             comm_scenario  = 'Z_SHOP_SCENARIO_OUTBOUND_E05'
*                                             comm_system_id = '<Comm System Id>'
                                             service_id     = 'Z_SHOP_API_READ_OBS_E05_REST' ).
lo_http_client = cl_web_http_client_manager=>create_by_http_destination( lo_destination ).

     lo_client_proxy = cl_web_odata_client_factory=>create_v2_remote_proxy(
       EXPORTING
         iv_service_definition_name = 'Z_SHOP_API_SCM_E05'
...
*                                        proxy_model_id      = 'Z_SHOP_API_SCM_E05'
...
" Set entity key
ls_entity_key = VALUE #(
          order_uuid  = 'AD19D34E17221EDDA9DB3A24849F8E31' ).
