class ZCL_SHOP_API_READ_F67 definition
  public
  create public .
...
CLASS ZCL_SHOP_API_READ_F67 IMPLEMENTATION.


  method IF_HTTP_SERVICE_EXTENSION~HANDLE_REQUEST.
  DATA:
  ls_entity_key    TYPE ZONLINE_SHOPF67,
  ls_business_data TYPE ZONLINE_SHOPF67,
...
DATA(lo_destination) = cl_http_destination_provider=>create_by_comm_arrangement(
                                             comm_scenario  = 'Z_SHOP_SCENARIO_OUTBOUND_F67'
                                             service_id     = 'Z_SHOP_API_READ_OBS_F67_REST' ).

lo_http_client = cl_web_http_client_manager=>create_by_http_destination( lo_destination ).
"     ASSERT lo_http_client IS BOUND.
     lo_client_proxy = cl_web_odata_client_factory=>create_v2_remote_proxy(
        EXPORTING
        iv_service_definition_name = 'Z_SHOP_API_SCM_F67'
