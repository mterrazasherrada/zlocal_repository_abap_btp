class ZCL_SHOP_API_READ_F03 definition
  public
  create public .
...
CLASS ZCL_SHOP_API_READ_F03 IMPLEMENTATION.


  method IF_HTTP_SERVICE_EXTENSION~HANDLE_REQUEST.

DATA:
  ls_entity_key    TYPE ZONLINE_SHOP2C9E3D0C5B,
  ls_business_data TYPE ZONLINE_SHOP2C9E3D0C5B,
...
DATA(lo_destination) = cl_http_destination_provider=>create_by_comm_arrangement(
                                             comm_scenario  = 'Z_SHOP_SCENARIO_OUTBOUND_F03'
                                             service_id     = 'Z_SHOP_API_READ_OBS_F03_REST' ).
...
*                                              proxy_model_id      = 'Z_SHOP_API_SCM_F03'
...
lo_client_proxy = cl_web_odata_client_factory=>create_v2_remote_proxy(
          EXPORTING
             iv_service_definition_name = 'Z_SHOP_API_SCM_F03'
             io_http_client = lo_http_client
             iv_relative_service_root = '').
...
" Set entity key
ls_entity_key = VALUE #(
          order_uuid  = 'DF0B7D5455421EDE89D275B500DE0C47' ).
