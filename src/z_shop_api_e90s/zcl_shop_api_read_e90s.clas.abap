CLASS zcl_shop_api_read_e90s DEFINITION
  PUBLIC
  CREATE PUBLIC .
...
CLASS ZCL_SHOP_API_READ_E90S IMPLEMENTATION.


  METHOD if_http_service_extension~handle_request.

    DATA:
      ls_entity_key    TYPE zonline_shop4020e19015,
      ls_business_data TYPE zonline_shop4020e19015,
    ...
    TRY.
        ...
        DATA(lo_destination) = cl_http_destination_provider=>create_by_comm_arrangement(
                                                     comm_scenario  = 'Z_SHOP_SCENARIO_OUTBOUND_E90S'
*                                                     comm_system_id = 'Z_SHOP_COMSYS_E90S'
                                                     service_id     = 'Z_SHOP_API_READ_OBS_E90S_REST' ).
        lo_http_client = cl_web_http_client_manager=>create_by_http_destination( lo_destination ).

        lo_client_proxy = cl_web_odata_client_factory=>create_v2_remote_proxy(
          EXPORTING
            iv_service_definition_name = 'Z_SHOP_API_SCM_E90S'
...
*                                        proxy_model_id      = 'Z_SHOP_API_SCM_E90S'
