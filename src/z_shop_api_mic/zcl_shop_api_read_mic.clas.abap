CLASS zcl_shop_api_read_mic DEFINITION
  PUBLIC
  CREATE PUBLIC .
...
CLASS ZCL_SHOP_API_READ_MIC IMPLEMENTATION.
  ...
  METHOD if_http_service_extension~handle_request.
    ...
    DATA:
      ls_entity_key    TYPE zonline_shopf3c0f7f730,
      ls_business_data TYPE zonline_shopf3c0f7f730,
    ...
    TRY.
        ...
        DATA(lo_destination) = cl_http_destination_provider=>create_by_comm_arrangement(
                                                     comm_scenario  = 'Z_SHOP_SCENARIO_OUTBOUND_MIC'
                                                     service_id     = 'Z_SHOP_API_READ_OBS_MIC_REST' ).
        lo_http_client = cl_web_http_client_manager=>create_by_http_destination( lo_destination ).

        lo_client_proxy = cl_web_odata_client_factory=>create_v2_remote_proxy(
          EXPORTING
            iv_service_definition_name = 'Z_SHOP_API_SCM_MIC'
...
*                                        proxy_model_id      = 'Z_SHOP_API_SCM_MIC'
...
*    iv_relative_service_root   = '<service_root>' ).
        ...
        " Set entity key
        ls_entity_key = VALUE #(
                  order_uuid  = 'CFF7131367531EEDB1F662096253524B' ).
