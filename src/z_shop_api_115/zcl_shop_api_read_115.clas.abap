CLASS zcl_shop_api_read_115 DEFINITION
  PUBLIC
  CREATE PUBLIC .
...
CLASS ZCL_SHOP_API_READ_115 IMPLEMENTATION.
...
*
*    DATA:
*      ls_entity_key    TYPE zonline_shop5c0e21b3a1,
*      ls_business_data TYPE zonline_shop5c0e21b3a1,
...
*                                                     comm_scenario  = 'Z_SHOP_SCENARIO_OUTBOUND_115'
**                                                     comm_system_id = '<COMM_SYSTEM>'
*                                                     service_id     = 'Z_SHOP_API_READ_OBS_115_REST' ).
...
**                                                 proxy_model_id      = 'Z_SHOP_API_SCM_115'
...
*            EXPORTING
*            iv_service_definition_name = 'Z_SHOP_API_SCM_115'
*            io_http_client = lo_http_client
*            iv_relative_service_root = ''
*        ).
*
...
*        " Handle Exception
*        response->set_text( |HTTP Clinet Error: { lx_web_http_client_error->get_longtext( ) }| ).
...
*    ENDTRY.
    ...
    TRY.
        ...
        " Set entity key
        ls_entity_key = VALUE #(
                  order_uuid  = 'E7AA1C3D298B1EDDBEC4739C10538696' ).
