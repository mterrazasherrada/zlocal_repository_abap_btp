class ZCL_SHOP_API_READ_J29 definition
  public
  create public .
...
CLASS ZCL_SHOP_API_READ_J29 IMPLEMENTATION.


  method IF_HTTP_SERVICE_EXTENSION~HANDLE_REQUEST.

    DATA:
      ls_entity_key    TYPE ZONLINE_SHOPA5573290DC,
      ls_business_data TYPE ZONLINE_SHOPA5573290DC,
    ...
    DATA(lo_destination) = cl_http_destination_provider=>create_by_comm_arrangement(
                                                 comm_scenario  = 'Z_SHOP_SCENARIO_OUTBOUND_J29'
*                                                 comm_system_id = '<Comm System Id>'
                                                 service_id     = 'Z_SHOP_API_READ_OBS_J29_REST' ).

    lo_http_client = cl_web_http_client_manager=>create_by_http_destination( lo_destination ).

     lo_client_proxy = cl_web_odata_client_factory=>create_v2_remote_proxy(
        EXPORTING
            iv_service_definition_name = 'Z_SHOP_API_SCM_J29'
...
*                                                  proxy_model_id      = 'Z_SHOP_API_SCM_J29'
...
*             iv_relative_service_root   = '<service_root>' ).
    ...
    " Set entity key
    ls_entity_key = VALUE #(
              order_uuid  = 'E7AA1C3D298B1EEE86DB093D9D66CF54' ).
