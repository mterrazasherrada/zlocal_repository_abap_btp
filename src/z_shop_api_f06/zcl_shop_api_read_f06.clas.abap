class ZCL_SHOP_API_READ_F06 definition
  public
  create public .
...
CLASS ZCL_SHOP_API_READ_F06 IMPLEMENTATION.


  method IF_HTTP_SERVICE_EXTENSION~HANDLE_REQUEST.
  DATA:
  ls_entity_key    TYPE ZONLINE_SHOPFA1924B88E,
  ls_business_data TYPE ZONLINE_SHOPFA1924B88E,
...
DATA(lo_destination) = cl_http_destination_provider=>create_by_comm_arrangement(
                                             comm_scenario  = 'Z_SHOP_SCENARIO_OUTBOUND_F06'
*                                             comm_system_id = '<Comm System Id>'
                                             service_id     = 'Z_SHOP_API_READ_OBS_F06_REST' ).
     ...
     lo_client_proxy = /iwbep/cl_cp_factory_remote=>create_v2_remote_proxy(
       EXPORTING
          is_proxy_model_key       = VALUE #( repository_id       = 'SRVD'
                                              proxy_model_id      = 'Z_SHOP_API_SCM_F06'
...
" Set entity key
ls_entity_key = VALUE #(
          order_uuid  = 'DF0B7D5455421EDE89CB41CA114A0132' ).
