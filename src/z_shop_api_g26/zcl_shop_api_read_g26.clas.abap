CLASS zcl_shop_api_read_g26 DEFINITION
  PUBLIC
  CREATE PUBLIC .
...
CLASS zcl_shop_api_read_g26 IMPLEMENTATION.


  METHOD if_http_service_extension~handle_request.

    DATA:
      ls_entity_key    TYPE zonline_shop037798a581,
      ls_business_data TYPE zonline_shop037798a581,
    ...
    TRY.
        ...
        DATA(lo_destination) = cl_http_destination_provider=>create_by_comm_arrangement(
                                                     comm_scenario  = 'Z_SHOP_SCENARIO_OUTBOUND_G26'
*                                             comm_system_id = '<Comm System Id>'
                                                     service_id     = 'Z_SHOP_API_READ_OBS_G26_REST' ).
        lo_http_client = cl_web_http_client_manager=>create_by_http_destination( lo_destination ).
        lo_client_proxy = cl_web_odata_client_factory=>create_v2_remote_proxy(
          EXPORTING
            iv_service_definition_name = 'Z_SHOP_API_SCM_G26'
        ...
        " Set entity key
        ls_entity_key = VALUE #(
                  order_uuid  = '374927A349381EEE90ADD044D76C8316' ).
