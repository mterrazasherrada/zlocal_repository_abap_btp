CLASS zcl_shop_api_read_h05 DEFINITION
  PUBLIC
  CREATE PUBLIC .
...
CLASS zcl_shop_api_read_h05 IMPLEMENTATION.


  METHOD if_http_service_extension~handle_request.

    DATA:
      ls_entity_key    TYPE zonline_shopf9e8c4c00b,
...
*                                             comm_system_id = ''
                                                     service_id     = 'Z_SHOP_API_READ_OBS_H05_REST' ).
        ...
        " Set entity key
        ls_entity_key = VALUE #(
                  order_uuid  = '357DF7EF1A351EEE97A62FE4317101A8' ).
