class ZCL_SHOP_API_READ_J13 definition
  public
  create public .
...
CLASS ZCL_SHOP_API_READ_J13 IMPLEMENTATION.


  method IF_HTTP_SERVICE_EXTENSION~HANDLE_REQUEST.

    DATA:
      ls_entity_key    TYPE ZONLINE_SHOPDFDFC22ADF,
      ls_business_data TYPE ZONLINE_SHOPDFDFC22ADF,
    ...
    TRY.
     ...
     DATA(lo_destination) = cl_http_destination_provider=>create_by_comm_arrangement(
                                                 comm_scenario  = 'Z_SHOP_SCENARIO_OUTBOUND_J13'
*                                                 comm_system_id = '<Comm System Id>'
                                                 service_id     = 'Z_SHOP_API_READ_OBS_J13_REST' ).
     ...
     lo_client_proxy = cl_web_odata_client_factory=>create_v2_remote_proxy(
       EXPORTING
          iv_service_definition_name = 'Z_SHOP_API_SCM_J13'
...
*                                                  proxy_model_id      = 'Z_SHOP_API_SCM_J13'
...
*             iv_relative_service_root   = '<service_root>' ).
    ...
    " Set entity key
    ls_entity_key = VALUE #(
              order_uuid  = 'E7AA1C3D298B1EDE86DBA805A7208E2F' ).
