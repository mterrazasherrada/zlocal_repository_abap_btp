class ZCL_SHOP_API_READ_J72 definition
  public
  create public .
...
CLASS ZCL_SHOP_API_READ_J72 IMPLEMENTATION.
...
DATA:
 " ls_entity_key    TYPE ZONLINE_SHOPE3D6537B0D,
...
DATA(lo_destination) = cl_http_destination_provider=>create_by_comm_arrangement(
                                            comm_scenario  = 'Z_SHOP_SCENERIO_OUTBOUND_J72'
                                            service_id     = 'Z_SHOP_API_READ_OBS_J72_REST' ).
...
EXPORTING
iv_service_definition_name = 'Z_SHOP_API_SCM_J72'
...
" Set entity key
ls_entity_key = VALUE #(
          order_uuid  = 'DF0B7D5455421EEE889DF2B778A0C0C8' ).
