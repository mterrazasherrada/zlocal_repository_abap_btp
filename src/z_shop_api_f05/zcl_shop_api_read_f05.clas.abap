CLASS zcl_shop_api_read_f05 DEFINITION
  PUBLIC
  CREATE PUBLIC .
...
CLASS ZCL_SHOP_API_READ_F05 IMPLEMENTATION.


  METHOD if_http_service_extension~handle_request.

    DATA:
      ls_entity_key    TYPE zonline_shop7360545ecc,
      ls_business_data TYPE zonline_shop7360545ecc,
    ...
    TRY.
        ...
        DATA(lo_destination) = cl_http_destination_provider=>create_by_comm_arrangement(
                                                     comm_scenario  = 'Z_SHOP_SCENARIO_OUTBOUND_F05'
                                                     service_id     = 'Z_SHOP_API_READ_OBS_F05_REST' ).
        ...
        lo_client_proxy = cl_web_odata_client_factory=>create_v2_remote_proxy(
          EXPORTING
             iv_service_definition_name = 'Z_SHOP_API_SCM_F05'
