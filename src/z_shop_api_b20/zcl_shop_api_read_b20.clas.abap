CLASS zcl_shop_api_read_b20 DEFINITION
  PUBLIC
  CREATE PUBLIC .
...
CLASS ZCL_SHOP_API_READ_B20 IMPLEMENTATION.


  METHOD if_http_service_extension~handle_request.

    DATA:
      ls_entity_key    TYPE zonline_shop98212dd82c,
      ls_business_data TYPE zonline_shop98212dd82c,
    ...
    TRY.
        ...
        DATA(lo_destination) = cl_http_destination_provider=>create_by_comm_arrangement(
                                                     comm_scenario  = 'Z_SHOP_SCENARIO_OUTBOUND_B20'
*                                             comm_system_id = '<Comm System Id>'
                                                     service_id     = 'Z_SHOP_API_READ_OBS_B20_REST' ).
        lo_http_client = cl_web_http_client_manager=>create_by_http_destination( lo_destination ).

        lo_client_proxy = cl_web_odata_client_factory=>create_v2_remote_proxy(
          EXPORTING
            iv_service_definition_name = 'Z_SHOP_API_SCM_B20'
...
*                                        proxy_model_id      = 'Z_SHOP_API_SCM_B20'
...
*    iv_relative_service_root   = '<service_root>' ).
        ...
        " Set entity key
        ls_entity_key = VALUE #(
                  order_uuid  = 'CFF7131367531EEDB6ACA461E8121663' ).
