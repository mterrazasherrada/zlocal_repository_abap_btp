class ZCL_SHOP_API_READ_F15 definition
  public
  create public .
...
CLASS ZCL_SHOP_API_READ_F15 IMPLEMENTATION.
...
comm_scenario = 'Z_SHOP_SCENARIO_OUTBOUND_F15'
* comm_system_id = '<Comm System Id>'
service_id = 'Z_SHOP_API_READ_OBS_F15_REST' ).
lo_http_client = cl_web_http_client_manager=>create_by_http_destination( lo_destination ).
lo_client_proxy = cl_web_odata_client_factory=>create_v2_remote_proxy(
EXPORTING
iv_service_definition_name = 'Z_SHOP_API_SCM_F15'
io_http_client = lo_http_client
iv_relative_service_root = '' ).
" Set entity key
ls_entity_key = VALUE #( order_uuid = 'DF0B7D5455421EDE89ADED847B81C1CB' ).
