class ZCL_SHOP_API_READ_B05 definition
  public
  create public .
...
CLASS ZCL_SHOP_API_READ_B05 IMPLEMENTATION.


  method IF_HTTP_SERVICE_EXTENSION~HANDLE_REQUEST.
  DATA:
  ls_entity_key    TYPE ZONLINE_SHOPDD91C16AF0,
  ls_business_data TYPE ZONLINE_SHOPDD91C16AF0,
...
DATA(lo_destination) = cl_http_destination_provider=>create_by_comm_arrangement(
                                             comm_scenario  = 'ZSHOP_SCENARIO_OUTBOUND_B05'
                                             service_id     = 'ZSHOP_API_OUTBOUND_B05_REST' ).
lo_http_client = cl_web_http_client_manager=>create_by_http_destination( lo_destination ).
     ...
     lo_client_proxy = cl_web_odata_client_factory=>create_v2_remote_proxy(
       EXPORTING
         iv_service_definition_name = 'ZSHOP_API_B05'
...
" Set entity key
ls_entity_key = VALUE #(
          order_uuid  = 'CFF7131367531EDDB6D3EB5D16FFD44B' ).
