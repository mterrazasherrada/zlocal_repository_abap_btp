class ZCL_SHOP_API_READ_F14 definition
  public
  create public .
...
CLASS ZCL_SHOP_API_READ_F14 IMPLEMENTATION.


  method IF_HTTP_SERVICE_EXTENSION~HANDLE_REQUEST.

DATA:
  ls_entity_key    TYPE ZONLINE_SHOP67B43CB842,
  ls_business_data TYPE ZONLINE_SHOP67B43CB842,
...
DATA(lo_destination) = cl_http_destination_provider=>create_by_comm_arrangement(
                                             comm_scenario  = 'Z_SHOP_SCENARIO_OUTBOUND_F14'

                                             service_id     = 'Z_SHOP_API_READ_OBS_F14_REST' ).
lo_http_client = cl_web_http_client_manager=>create_by_http_destination( lo_destination ).
     ...
     lo_client_proxy = cl_web_odata_client_factory=>create_v2_remote_proxy(
          EXPORTING
             iv_service_definition_name = 'Z_SHOP_API_SCM_F14'
             io_http_client = lo_http_client
             iv_relative_service_root = '').
*     lo_client_proxy = /iwbep/cl_cp_factory_remote=>create_v2_remote_proxy(
*       EXPORTING
*          is_proxy_model_key       = VALUE #( repository_id       = 'SRVD'
*                                              proxy_model_id      = 'Z_SHOP_API_SCM_F14'
...
" Set entity key
ls_entity_key = VALUE #(
          order_uuid  = 'DF0B7D5455421EDE8A99CD02F7290634' ).
