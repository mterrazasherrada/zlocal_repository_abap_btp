class ZCL_SHOP_API_READ_F61 definition
  public
  create public .
...
CLASS ZCL_SHOP_API_READ_F61 IMPLEMENTATION.


  method IF_HTTP_SERVICE_EXTENSION~HANDLE_REQUEST.
  DATA:
 ls_entity_key TYPE ZZC_ONLINE_SHOP_F61,
 ls_business_data TYPE ZZC_ONLINE_SHOP_F61,
 ...
 comm_scenario = 'Z_SHOP_SCENARIO_OUTBOUND_F61'
* comm_system_id = '<Comm System Id>'
 service_id = 'Z_SHOP_API_READ_OBS_F61_REST' ).
 lo_http_client = cl_web_http_client_manager=>create_by_http_destination( lo_destination ).
 lo_client_proxy = cl_web_odata_client_factory=>create_v2_remote_proxy(
 EXPORTING
 iv_service_definition_name = 'ZSHOP_API_F61'
