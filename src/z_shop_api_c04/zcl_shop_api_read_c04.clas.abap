class ZCL_SHOP_API_READ_C04 definition
  public
  create public .
...
CLASS ZCL_SHOP_API_READ_C04 IMPLEMENTATION.


  method IF_HTTP_SERVICE_EXTENSION~HANDLE_REQUEST.

DATA:
  ls_entity_key    TYPE ZONLINE_SHOP9E0A632FD1,
  ls_business_data TYPE ZONLINE_SHOP9E0A632FD1,
  ...
  TRY.
     ...
     DATA(lo_destination) = cl_http_destination_provider=>create_by_comm_arrangement(
                                             comm_scenario  = 'Z_SHOP_SCENARIO_OUTBOUND_C04'
*                                             comm_system_id = '<Comm System Id>'
                                             service_id     = 'Z_SHOP_API_READ_OBS_C04_REST' ).
...
*         iv_relative_service_root   = '<service_root>' ).
       ...
       lo_client_proxy = cl_web_odata_client_factory=>create_v2_remote_proxy(
         EXPORTING
         iv_service_definition_name = 'Z_SHOP_API_SCM_C04'
         io_http_client = lo_http_client
         iv_relative_service_root = '' ).

" Set entity key
     ls_entity_key = VALUE #(
          order_uuid  = 'E7AA1C3D298B1EDDBFF3C633D6C953F4' ).
