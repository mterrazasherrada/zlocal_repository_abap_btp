class ZCL_SHOP_API_READ_K53 definition
  public
  create public .
...
CLASS ZCL_SHOP_API_READ_K53 IMPLEMENTATION.


  method IF_HTTP_SERVICE_EXTENSION~HANDLE_REQUEST.

    DATA:
      ls_entity_key    TYPE zonline_shopa57f28c537,
      ls_business_data TYPE zonline_shopa57f28c537,
      ...
      lo_response      TYPE REF TO /iwbep/if_cp_response_read.
         ...
         TRY.
            ...
            DATA(lo_destination) = cl_http_destination_provider=>create_by_comm_arrangement(
                                                         comm_scenario  = 'Z_SHOP_SCENARIO_OUTBOUND_K53'
                                                         service_id     = 'Z_SHOP_API_READ_OBS_K53_REST' ).
            lo_http_client = cl_web_http_client_manager=>create_by_http_destination( lo_destination ).

                 lo_client_proxy = cl_web_odata_client_factory=>create_v2_remote_proxy(
                   EXPORTING
                     iv_service_definition_name = 'Z_SHOP_API_SCM_K53'
...
*                                                    proxy_model_id      = 'Z_SHOP_API_SCM_K53'
...
*                      order_uuid  = '11112222333344445555666677778888' ).
                       order_uuid  = 'AD19D34E17221EDDAFB24C058284940A' ).
