class ZCL_SHOP_API_READ_B28 definition
  public
  create public .
...
CLASS ZCL_SHOP_API_READ_B28 IMPLEMENTATION.


  method IF_HTTP_SERVICE_EXTENSION~HANDLE_REQUEST.

DATA:
  ls_entity_key    TYPE ZONLINE_SHOP9D7F0FA46D,
  ls_business_data TYPE ZONLINE_SHOP9D7F0FA46D,
...
DATA(lo_destination) = cl_http_destination_provider=>create_by_comm_arrangement(
                                             comm_scenario  = 'Z_SHOP_SCENARIO_OUTBOUND_B28'
                                             service_id     = 'Z_SHOP_API_READ_OBS_B28_REST' ).
lo_http_client = cl_web_http_client_manager=>create_by_http_destination( lo_destination ).

     lo_client_proxy = cl_web_odata_client_factory=>create_v2_remote_proxy(
       EXPORTING
         iv_service_definition_name = 'Z_SHOP_API_SCM_B28'
...
*                                        proxy_model_id      = 'Z_SHOP_API_SCM_B28'
...
" Set entity key
ls_entity_key = VALUE #(
          order_uuid  = 'CFF7131367531EDDB6AD96F4345F6366' ).
