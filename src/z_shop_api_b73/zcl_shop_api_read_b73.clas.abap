CLASS zcl_shop_api_read_b73 DEFINITION
  PUBLIC
  CREATE PUBLIC .
...
CLASS ZCL_SHOP_API_READ_B73 IMPLEMENTATION.


  METHOD if_http_service_extension~handle_request.
    DATA:
      ls_entity_key    TYPE ZONLINE_SHOP77654C0FC4,
      ls_business_data TYPE ZONLINE_SHOP77654C0FC4,
    ...
    TRY.
        ...
        DATA(lo_destination) = cl_http_destination_provider=>create_by_comm_arrangement(
                                                     comm_scenario  = 'Z_SHOP_SCENARIO_OUTBOUND_B73'
*                                             comm_system_id = '<Comm System Id>'
                                                     service_id     = 'Z_SHOP_API_READ_OBS_B73_REST' ).

        lo_http_client = cl_web_http_client_manager=>create_by_http_destination( lo_destination ).

        lo_client_proxy = cl_web_odata_client_factory=>create_v2_remote_proxy(
          EXPORTING
            iv_service_definition_name = 'Z_SHOP_ACI_SCM_B73'
...
*                                        proxy_model_id      = 'Z_SHOP_ACI_SCM_B73'
...
*    iv_relative_service_root   = '<service_root>' ).
        ...
        " Set entity key
        ls_entity_key = VALUE #(
                  order_uuid  = 'DD5F294E1FD01EDDBA9DC32002234BBF' ).
