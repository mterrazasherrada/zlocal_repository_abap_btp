class ZCL_SHOP_API_READ_46 definition
  public
  create public .
...
CLASS ZCL_SHOP_API_READ_46 IMPLEMENTATION.


  method IF_HTTP_SERVICE_EXTENSION~HANDLE_REQUEST.
       DATA:
        " ZONLINE_SHOP31BF5701F6
    ...
    TRY.
        ...
        DATA(lo_destination) = cl_http_destination_provider=>create_by_comm_arrangement(
                                                     comm_scenario  = 'Z_SHOP_SCENARIO_OUTBOUND_46'
                                                     service_id     = 'Z_SHOP_API_READ_OBS_46_REST' ).
        ...
        lo_client_proxy = cl_web_odata_client_factory=>create_v2_remote_proxy(
          EXPORTING
            iv_service_definition_name = 'Z_SHOP_API_SCM_46'
