class ZCL_SHOP_API_READ_J08 definition
  public
  create public .
...
CLASS ZCL_SHOP_API_READ_J08 IMPLEMENTATION.


  method IF_HTTP_SERVICE_EXTENSION~HANDLE_REQUEST.

DATA:
  ls_entity_key    TYPE ZONLINE_SHOPEEEEA62129,
  ls_business_data TYPE ZONLINE_SHOPEEEEA62129,
...
DATA(lo_destination) = cl_http_destination_provider=>create_by_comm_arrangement(
                                             comm_scenario  = 'Z_SHOP_SCENARIO_OUTBOUND_J08'
*                                             comm_system_id = '<Comm System Id>'
                                             service_id     = 'Z_SHOP_API_READ_OBS_J08_REST' ).
lo_http_client = cl_web_http_client_manager=>create_by_http_destination( lo_destination ).
 ...
 EXPORTING
 iv_service_definition_name = 'Z_SHOP_API_SCM_J08'
 io_http_client = lo_http_client
 iv_relative_service_root = '' ).
*     lo_client_proxy = /iwbep/cl_cp_factory_remote=>create_v2_remote_proxy(
*       EXPORTING
*          is_proxy_model_key       = VALUE #( repository_id       = 'SRVD'
*                                              proxy_model_id      = 'Z_SHOP_API_SCM_J08'
...
" Set entity key
ls_entity_key = VALUE #(
          order_uuid  = 'E7AA1C3D298B1EEE86DD685E288310DF' ).
