class ZCL_SHOP_API_READ_F100 definition
  public
  create public .
...
CLASS ZCL_SHOP_API_READ_F100 IMPLEMENTATION.


  method IF_HTTP_SERVICE_EXTENSION~HANDLE_REQUEST.

  DATA:
  ls_entity_key    TYPE ZONLINE_SHOP698E8C068E,
  ls_business_data TYPE ZONLINE_SHOP698E8C068E,
...
DATA(lo_destination) = cl_http_destination_provider=>create_by_comm_arrangement(
                                             comm_scenario  = 'Z_SHOP_SCENARIO_OUTBOUND_F100'
*                                             comm_system_id = ' '
                                             service_id     = 'Z_SHOP_API_READ_OBS_F100_REST' ).
     ...
     lo_client_proxy = /iwbep/cl_cp_factory_remote=>create_v2_remote_proxy(
       EXPORTING
          is_proxy_model_key       = VALUE #( repository_id       = 'SRVD'
                                              proxy_model_id      = 'Z_SHOP_API_SCM_F100'
