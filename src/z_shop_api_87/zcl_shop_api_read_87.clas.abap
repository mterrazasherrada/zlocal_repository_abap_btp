class ZCL_SHOP_API_READ_87 definition
  public
  create public .
...
CLASS ZCL_SHOP_API_READ_87 IMPLEMENTATION.
...
DATA:
  ls_entity_key    TYPE ZONLINE_SHOPC74F3193A0,
  ls_business_data TYPE ZONLINE_SHOPC74F3193A0,
...
DATA(lo_destination) = cl_http_destination_provider=>create_by_comm_arrangement(
                                             comm_scenario  = 'Z_SHOP_SCENARIO_OUTBOUND_87'
*                                             comm_system_id = '<Comm System Id>'
                                             service_id     = 'Z_SHOP_API_READ_OBS_87_REST' ).
lo_http_client = cl_web_http_client_manager=>create_by_http_destination( lo_destination ).

     lo_client_proxy = cl_web_odata_client_factory=>create_v2_remote_proxy(
       EXPORTING
         iv_service_definition_name = 'Z_SHOP_API_SCM_87'
...
*                                        proxy_model_id      = 'Z_SHOP_API_SCM_87'
...
" Set entity key
ls_entity_key = VALUE #(
          order_uuid  = 'CFF7131367531EEDB1F6471930C74FD3' ).
