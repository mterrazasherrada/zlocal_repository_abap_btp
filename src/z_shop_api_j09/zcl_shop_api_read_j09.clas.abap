class ZCL_SHOP_API_READ_J09 definition
  public
  create public .
...
CLASS ZCL_SHOP_API_READ_J09 IMPLEMENTATION.


  method IF_HTTP_SERVICE_EXTENSION~HANDLE_REQUEST.

DATA:
  ls_entity_key    TYPE ZONLINE_SHOP6822558781,
  ls_business_data TYPE ZONLINE_SHOP6822558781,
  ...
  lo_response      TYPE REF TO /iwbep/if_cp_response_read.
     ...
     DATA(lo_destination) = cl_http_destination_provider=>create_by_comm_arrangement(
                                             comm_scenario  = 'Z_SHOP_SCENARIO_OUTBOUND_J09'
*                                             comm_system_id = '<Comm System Id>'
                                             service_id     = 'Z_SHOP_API_READ_OBS_J09_REST' ).
     ...
     lo_client_proxy = cl_web_odata_client_factory=>create_v2_remote_proxy(
       EXPORTING
         iv_service_definition_name = 'Z_SHOP_API_SCM_J09'
         io_http_client = lo_http_client
         iv_relative_service_root = '' ).
*     lo_client_proxy = /iwbep/cl_cp_factory_remote=>create_v2_remote_proxy(
*       EXPORTING
*          is_proxy_model_key       = VALUE #( repository_id       = 'SRVD'
*                                              proxy_model_id      = 'Z_SHOP_API_SCM_J09'
...
" Set entity key
ls_entity_key = VALUE #(
          order_uuid  = 'E7AA1C3D298B1EDE86DB61A317FEA2CE' ).
